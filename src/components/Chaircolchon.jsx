...
Command: npx gltfjsx@6.2.15 .\public\models\chaircolchon.gltf -K -k 
*/
...
const Chaircolchon = (props) => {
  const { nodes, materials } = useGLTF('models/chaircolchon.gltf')
  ...
  return (
    <group {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh
          name="pata2"
          geometry={nodes.pata2.geometry}
          material={materials.Material__53}
          visible={legs === 2}
        >
          <meshStandardMaterial {...plasticTextureProps} />
        </mesh>
...
useGLTF.preload('models/chaircolchon.gltf')

export default Chaircolchon;